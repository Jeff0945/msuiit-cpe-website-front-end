<template>
  ...
  <section class="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl lg:max-w-4xl">
      <figure class="mt-10">
        <blockquote class="text-center text-lg font-semibold leading-8 text-gray-900 sm:text-3xl sm:leading-9">
          <p>Coming soon</p>
        </blockquote>
        <figcaption class="mt-10">
          <img class="mx-auto h-28 w-28 rounded-full" src="/img/icpepse-msuiit-logo.jpg" alt="" />
          <div class="mt-4 flex items-center justify-center space-x-3 text-base">
            <div class="font-semibold text-gray-900">ICpEP.SE</div>
            <svg viewBox="0 0 2 2" width="3" height="3" aria-hidden="true" class="fill-gray-900">
              <circle cx="1" cy="1" r="1" />
            </svg>
            <div class="text-gray-600">MSU - IIT</div>
          </div>
        </figcaption>
      </figure>
    </div>
